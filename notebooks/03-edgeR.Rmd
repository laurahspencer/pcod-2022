...
ggplot(data = nonlinear_interaction_degs_avg, 
  ...
  scale_x_discrete(limits=c(3,6,10)) +
  theme(strip.background = element_blank()) +
  labs(y = "Expression level (logCPM)", x="Temperature",
       color = "pCO2 treatment", linetype="pCO2",
  ...
  scale_linetype_manual(values=c("solid", "dashed"), labels=c("370"="Ambient", "950"="High"))
